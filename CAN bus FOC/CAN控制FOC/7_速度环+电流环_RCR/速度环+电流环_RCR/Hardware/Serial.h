...
#define  DEBUG_USART_BAUDRATE           2000000
// USART GPIO 引脚宏定义
...
#define RX_BUF_SIZE 64                   // 接收缓存大小，可容纳最长64位数字字符串

/* 如果外部模块要访问接收结果，就保留这些 extern */
extern char Serial_RxBuffer[RX_BUF_SIZE];
extern uint8_t Serial_RxIndex;
extern uint8_t Serial_RxFlag;
extern float Serial_RxData;
